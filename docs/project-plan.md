...
| Layer | Technology |
|---|---|
| Frontend | index.html ไฟล์เดียว — "The Silent Concierge" UI, chat bubbles, confirmation flow, cancel button, workspace selector, file panel |
