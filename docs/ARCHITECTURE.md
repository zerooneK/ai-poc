...
The Next.js shell now also supports a collapsible sidebar, with compact workspace, file, and session controls rendered directly in the same page component.
