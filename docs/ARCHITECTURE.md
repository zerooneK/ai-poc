...
The Next.js shell now also supports a collapsible sidebar, with the collapse control inside the sidebar itself and the workspace selector anchored at the bottom of that rail.
